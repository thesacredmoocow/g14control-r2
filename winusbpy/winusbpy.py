...
class WinUsbPy(object):
    ...
    def init_winusb_device(self, name, vid, pid):
        ...
        #print("vid: ", id)
        #print("pid: ", pid)
        for i in self.device_paths:
            if i == self._name:
                path = self.device_paths[i]
            #print("Path: ", self.device_paths[i])
        """try:
